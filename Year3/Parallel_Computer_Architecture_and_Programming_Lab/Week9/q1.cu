...
// Host function to generate a random sparse matrix in CSR format
...
int main() {
    ...
    int num_rows = 5;
    int num_cols = 5;
    int nnz = 12;  // Number of non-zero elements
